...
const iVsI: Row[] = [
  ...
  ['teen', 'tin', 1, '/tiːn/', '/tɪn/', 'iVsI', 'medial'],
  ['deed', 'did', 1, '/diːd/', '/dɪd/', 'iVsI', 'medial'],
  ['leave', 'live', 2, '/liːv/', '/lɪv/', 'iVsI', 'medial'],
  ['feel', 'fill', 2, '/fiːl/', '/fɪl/', 'iVsI', 'medial'],
  ['heat', 'hit', 2, '/hiːt/', '/hɪt/', 'iVsI', 'medial'],
  ['bead', 'bid', 2, '/biːd/', '/bɪd/', 'iVsI', 'medial'],
  ['beat', 'bit', 3, '/biːt/', '/bɪt/', 'iVsI', 'medial'],
  ['heal', 'hill', 3, '/hiːl/', '/hɪl/', 'iVsI', 'medial'],
  ['meal', 'mill', 3, '/miːl/', '/mɪl/', 'iVsI', 'medial'],
