export const englishTranslations = {
    ...
    practicedTime: 'Practiced {minutes} {unit}',
    notPracticedYet: 'Not practiced yet',
    correctOfWeighted: '{correct} of {total} correct · weighted {accuracy}%',
    min: 'min',
    ...
    audioPlaybackFailed: 'Unable to play audio.',
    ...
    correctYouHeardIn: 'Correct — you heard {phoneme} in {word}.',
...
export const alternateLanguages: Record<string, TranslationSchema> = {
  ...
  日本語: {
    ...
    practicedTime: '{minutes}{unit}練習済み',
    notPracticedYet: 'まだ練習していません',
    correctOfWeighted: '{total}問中{correct}問正解 · 加重正答率 {accuracy}%',
    min: '分',
    ...
    dailyGoal: '1日の目標',
    levelOf: 'レベル',
    levelProgress: 'レベル {level} / {total}',
    levelCompact: 'レベル {level}',
    levelAt: 'レベル {level}',
    mastered: 'マスター済み',
    ...
    audioError: 'オーディオエラー',
    audioPlaybackFailed: '音声を再生できません。',
    ...
    correctYouHeardIn: '正解。{word} の {phoneme} を聞き取りました。',
  ...
  中文: {
    ...
    practicedTime: '已练习 {minutes} {unit}',
    notPracticedYet: '尚未练习',
    correctOfWeighted: '答对 {correct}/{total} · 加权准确率 {accuracy}%',
    min: '分钟',
    ...
    dailyGoal: '每日目标',
    levelOf: '等级',
    levelProgress: '第 {level} 级（共 {total} 级）',
    levelCompact: '第 {level} 级',
    levelAt: '第 {level} 级',
    mastered: '已掌握',
    levelUnlocked: '升级了！',
    ...
    correctYouHeardIn: '正确。你听到了 {word} 中的 {phoneme}。',
  ...
  ภาษาไทย: {
    ...
    practicePairs: 'ฝึก',
    playAudio: 'เล่นเสียง',
    listening: 'กำลังเล่นเสียง…',
    accuracyTrend: 'แนวโน้มความถูกต้องล่าสุด',
    timePracticed: 'เวลาฝึกฝนล่าสุด',
    practicedTime: 'ฝึกไปแล้ว {minutes} {unit}',
    notPracticedYet: 'ยังไม่ได้ฝึก',
    correctOfWeighted: 'ถูก {correct} จาก {total} ข้อ · ความแม่นยำถ่วงน้ำหนัก {accuracy}%',
    min: 'นาที',
    ...
    levelOf: 'ระดับ',
    levelProgress: 'ระดับ {level} จาก {total}',
    levelCompact: 'ระดับ {level}',
    levelAt: 'ระดับ {level}',
    ...
    audioPlaybackFailed: 'ไม่สามารถเล่นเสียงได้',
    ...
    correctYouHeardIn: 'ถูกต้อง — คุณได้ยิน {phoneme} ในคำว่า {word}',
  ...
  Español: {
    ...
    practicedTime: 'Practicado {minutes} {unit}',
    notPracticedYet: 'Aún no se ha practicado',
    correctOfWeighted: '{correct} de {total} correctas · ponderado {accuracy}%',
    min: 'minutos',
    ...
    levelOf: 'Nivel',
    levelProgress: 'Nivel {level} de {total}',
    levelCompact: 'Nv. {level}',
    levelAt: 'Nivel {level}',
    mastered: 'Dominado',
    ...
    audioPlaybackFailed: 'No se pudo reproducir el audio.',
    ...
    correctYouHeardIn: 'Correcto: escuchaste {phoneme} en {word}.',
  ...
  العربية: {
    ...
    practicedTime: 'تدرّبت لمدة {minutes} {unit}',
    notPracticedYet: 'لم يتم التدريب بعد',
    correctOfWeighted: '{correct} من {total} صحيحة · الدقة المرجّحة {accuracy}%',
    min: 'دقائق',
    ...
    levelOf: 'المستوى',
    levelProgress: 'المستوى {level} من {total}',
    levelCompact: 'المستوى {level}',
    levelAt: 'المستوى {level}',
    mastered: 'متقن',
    ...
    audioPlaybackFailed: 'تعذر تشغيل الصوت.',
    ...
    correctYouHeardIn: 'صحيح — سمعت {phoneme} في {word}.',
  ...
  Русский: {
    ...
    practicedTime: 'Практика: {minutes} {unit}',
    notPracticedYet: 'Еще не практиковалось',
    correctOfWeighted: '{correct} из {total} верно · взвешенная точность {accuracy}%',
    min: 'мин',
    ...
    levelOf: 'Уровень',
    levelProgress: 'Уровень {level} из {total}',
    levelCompact: 'ур. {level}',
    levelAt: 'Уровень {level}',
    mastered: 'Освоено',
    ...
    audioPlaybackFailed: 'Не удалось воспроизвести аудио.',
    ...
    correctYouHeardIn: 'Верно — вы услышали {phoneme} в слове {word}.',
  ...
  한국어: {
    ...
    practicedTime: '{minutes}{unit} 연습함',
    notPracticedYet: '아직 연습하지 않았습니다',
    correctOfWeighted: '{total}개 중 {correct}개 정답 · 가중 정확도 {accuracy}%',
    min: '분',
    ...
    dailyGoal: '일일 목표',
    levelOf: '레벨',
    levelProgress: '레벨 {level} / {total}',
    levelCompact: '레벨 {level}',
    levelAt: '레벨 {level}',
    mastered: '마스터 완료',
    levelUnlocked: '레벨 업!',
    ...
    audioError: '오디오 오류',
    audioPlaybackFailed: '오디오를 재생할 수 없습니다.',
    ...
    correctYouHeardIn: '정답 — {word}에서 {phoneme}을(를) 들었습니다.',
  ...
  'हिन्दी / اردو': {
    ...
    listening: 'सुन रहे हैं… / سن رہے ہیں…',
    accuracyTrend: 'हाल की सटीकता प्रवृत्ति/حالیہ درستگی کا رجحان',
    timePracticed: 'हाल का अभ्यास समय/حالیہ مشق کا وقت',
    practicedTime: '{minutes} {unit} अभ्यास किया / {minutes} {unit} مشق کی',
    notPracticedYet: 'अभी अभ्यास नहीं किया / ابھی مشق نہیں کی',
    correctOfWeighted: '{total} में से {correct} सही · भारित सटीकता {accuracy}% / {total} میں سے {correct} درست · وزنی درستگی {accuracy}%',
    min: 'मिनट/منٹ',
    ...
    levelOf: 'स्तर',
    levelProgress: 'स्तर {level} में से {total} / سطح {level} از {total}',
    levelCompact: 'स्तर {level} / سطح {level}',
    levelAt: 'स्तर {level} / سطح {level}',
    ...
    audioPlaybackFailed: 'ऑडियो नहीं चलाया जा सका। / آڈیو نہیں چل سکا۔',
    ...
    correctYouHeardIn: 'सही — आपने {word} में {phoneme} सुना। / صحیح — آپ نے {word} میں {phoneme} سنا۔',
  ...
  Português: {
    ...
    practicedTime: 'Praticado por {minutes} {unit}',
    notPracticedYet: 'Ainda não praticado',
    correctOfWeighted: '{correct} de {total} corretas · precisão ponderada {accuracy}%',
    min: 'minutos',
    ...
    levelOf: 'Nível',
    levelProgress: 'Nível {level} de {total}',
    levelCompact: 'Nív. {level}',
    levelAt: 'Nível {level}',
    mastered: 'Dominado',
    ...
    audioPlaybackFailed: 'Não foi possível reproduzir o áudio.',
    ...
    correctYouHeardIn: 'Correto — você ouviu {phoneme} em {word}.',
  ...
  'Tiếng Việt': {
    ...
    practicedTime: 'Đã luyện tập {minutes} {unit}',
    notPracticedYet: 'Chưa luyện tập',
    correctOfWeighted: 'Đúng {correct}/{total} · độ chính xác có trọng số {accuracy}%',
    min: 'phút',
    ...
    levelOf: 'Cấp',
    levelProgress: 'Cấp {level} trên {total}',
    levelCompact: 'Cấp {level}',
    levelAt: 'Cấp {level}',
    mastered: 'Thành thạo',
    ...
    correctYouHeardIn: 'Đúng — bạn đã nghe {phoneme} trong từ {word}.',
  ...
  Türkçe: {
    ...
    practicedTime: '{minutes} {unit} pratik yapıldı',
    notPracticedYet: 'Henüz pratik yapılmadı',
    correctOfWeighted: '{total} soruda {correct} doğru · ağırlıklı doğruluk %{accuracy}',
    min: 'dakika',
    ...
    levelOf: 'Seviye',
    levelProgress: 'Seviye {level} / {total}',
    levelCompact: 'Sv. {level}',
    levelAt: 'Seviye {level}',
    mastered: 'Tamamlandı',
    ...
    audioPlaybackFailed: 'Ses oynatılamadı.',
    ...
    correctYouHeardIn: 'Doğru — {word} içindeki {phoneme} sesini duydunuz.',
  ...
  فارسی: {
    ...
    practicedTime: '{minutes} {unit} تمرین شده',
    notPracticedYet: 'هنوز تمرین نشده است',
    correctOfWeighted: '{correct} از {total} درست · دقت وزنی {accuracy}٪',
    min: 'دقیقه',
    ...
    levelOf: 'سطح',
    levelProgress: 'سطح {level} از {total}',
    levelCompact: 'سطح {level}',
    levelAt: 'سطح {level}',
    mastered: 'تسلط یافته',
    ...
    audioPlaybackFailed: 'پخش صدا ممکن نیست.',
    ...
    correctYouHeardIn: 'درست — {phoneme} را در {word} شنیدید.',
  ...
  廣東話: {
    ...
    practicedTime: '已練習 {minutes} {unit}',
    notPracticedYet: '尚未練習',
    correctOfWeighted: '答對 {correct}/{total} · 加權準確率 {accuracy}%',
    min: '分鐘',
    ...
    dailyGoal: '每日目標',
    levelOf: '等級',
    levelProgress: '第 {level} 級（共 {total} 級）',
    levelCompact: '第 {level} 級',
    levelAt: '第 {level} 級',
    mastered: '已掌握',
    levelUnlocked: '升級了！',
    ...
    correctYouHeardIn: '啱，你聽到 {word} 入面嘅 {phoneme}。',
  ...
  'Bahasa Indonesia': {
    ...
    practicedTime: 'Berlatih selama {minutes} {unit}',
    notPracticedYet: 'Belum berlatih',
    correctOfWeighted: '{correct} dari {total} benar · akurasi berbobot {accuracy}%',
    min: 'menit',
    ...
    levelOf: 'Level',
    levelProgress: 'Level {level} dari {total}',
    levelCompact: 'Level {level}',
    levelAt: 'Level {level}',
    mastered: 'Dikuasai',
    ...
    audioPlaybackFailed: 'Audio tidak dapat diputar.',
    ...
    correctYouHeardIn: 'Benar — kamu mendengar {phoneme} dalam {word}.',
