...
export const alternateLanguages: Record<string, TranslationSchema> = {
  ...
  日本語: {
    ...
    practiceThisNextReasonNew: 'このペアはまだ練習していません。',
    practiceThisNextEmpty: 'いくつかのペアを練習すると、おすすめが表示されます。',
  },
  ...
  中文: {
    ...
    practiceThisNextReasonNew: '你还没有练习过这个配对。',
    practiceThisNextEmpty: '多练习几个配对即可获得推荐。',
  },
  ภาษาไทย: {
    home: 'หน้าแรก',
    results: 'ผลลัพธ์',
    ...
    practiceThisNextReasonNew: 'คุณยังไม่ได้ฝึกคู่นี้',
    practiceThisNextEmpty: 'ฝึกสักสองสามคู่เพื่อรับคำแนะนำ',
  },
  Español: {
    home: 'Inicio',
    results: 'Resultados',
    ...
    practiceThisNextReasonNew: 'Aún no has practicado este par.',
    practiceThisNextEmpty: 'Practica algunos pares para obtener una recomendación.',
  },
  العربية: {
    home: 'الرئيسية',
    results: 'النتائج',
    ...
    practiceThisNextReasonNew: 'لم تتدرّب على هذا الزوج بعد.',
    practiceThisNextEmpty: 'تدرّب على بعض الأزواج للحصول على توصية.',
  },
  Русский: {
    home: 'Главная',
    results: 'Результаты',
    ...
    practiceThisNextReasonNew: 'Вы ещё не практиковали эту пару.',
    practiceThisNextEmpty: 'Попрактикуйте несколько пар, чтобы получить рекомендацию.',
  },
  한국어: {
    home: '홈',
    results: '결과',
    ...
    practiceThisNextReasonNew: '이 쌍은 아직 연습하지 않았습니다.',
    practiceThisNextEmpty: '몇 개의 쌍을 연습하면 추천을 받을 수 있습니다.',
  },
  'हिन्दी / اردو': {
    home: 'होम/ہوم',
    ...
    practiceThisNextReasonNew: 'आपने अभी तक इस जोड़ी का अभ्यास नहीं किया है।/آپ نے ابھی تک یہ جوڑی مشق نہیں کی۔',
    practiceThisNextEmpty: 'कुछ जोड़ियों का अभ्यास करें ताकि सुझाव मिल सके।/کچھ جوڑوں کی مشق کریں تاکہ تجویز مل سکے۔',
  },
  Português: {
    home: 'Início',
    results: 'Resultados',
    ...
    practiceThisNextReasonNew: 'Você ainda não praticou este par.',
    practiceThisNextEmpty: 'Pratique alguns pares para receber uma recomendação.',
  },
  'Tiếng Việt': {
    home: 'Trang chủ',
    results: 'Kết quả',
    ...
    practiceThisNextReasonNew: 'Bạn chưa luyện tập cặp này.',
    practiceThisNextEmpty: 'Hãy luyện vài cặp để nhận gợi ý.',
  },
  Türkçe: {
    home: 'Ana Sayfa',
    results: 'Sonuçlar',
    ...
    practiceThisNextReasonNew: 'Bu çifti henüz çalışmadın.',
    practiceThisNextEmpty: 'Öneri almak için birkaç çift çalış.',
  },
  فارسی: {
    home: 'خانه',
    results: 'نتایج',
    ...
    practiceThisNextReasonNew: 'هنوز این جفت را تمرین نکرده‌اید.',
    practiceThisNextEmpty: 'چند جفت را تمرین کنید تا پیشنهاد دریافت کنید.',
  },
  廣東話: {
    home: '首頁',
    results: '結果',
    ...
    practiceThisNextReasonNew: '你仲未練過呢對。',
    practiceThisNextEmpty: '練多幾對就會有推薦。',
  },
  'Bahasa Indonesia': {
    home: 'Beranda',
    results: 'Hasil',
    ...
    practiceThisNextReasonNew: 'Anda belum melatih pasangan ini.',
    practiceThisNextEmpty: 'Latih beberapa pasangan untuk mendapatkan rekomendasi.',
  },
};
